          ...
          <div className="bg-white p-6 rounded-md shadow-sm">
            <div className="flex flex-col md:flex-row md:items-start gap-4">
              <div className="flex-1">
                <img
                  src="/images/insertimages.png"
                  alt="Upload Placeholder"
                  className="border border-gray-300 rounded-md w-full max-w-lg"
                />
              </div>
              <div>
                <input
                ...
                <p className="text-sm text-gray-600 mb-2 max-w-xs leading-relaxed">
                  ...
                  Maximum 10 minutes, 500 MB. Supported formats:{" "}
                  <code>.mp4</code>, <code>.mov</code>, or <code>.webm</code>.
                </p>
                <button
