      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <div className="flex flex-col gap-6">
            <HeadProfile name={user.full_name} email={user.email} avatar={user.avatar} />
            <InformationProfile name={user.full_name} email={user.email} phone={"08237213123"} plan={"Frontend Developer"} level={"Intermediate"} onLogout={logout} />
          </div>
          <div className="md:col-span-2">
            <SettingProfile name={user.full_name} email={user.email} lastName={"Didi"}/>
          </div>
        </div>
      </div>
    </section>
